...
if (!globalThis.define) {
  ...
  globalThis.define = (depsNames, factory) => {
    const uri = nextDefineUri || ("document" in globalThis ? document.currentScript.src : "") || location.href;
    if (registry[uri]) {
...
define(['./workbox-78b8c21c'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.origin === "https://dummyjson.com" || url.pathname.startsWith("/api"), new workbox.NetworkFirst({
    "cacheName": "api-cache",
